...
- Found in src/TSwapPool.sol [Line: 407](src/TSwapPool.sol#L407)

	```solidity
	            outputToken.safeTransfer(msg.sender, 1_000_000_000_000_000_000);
	```

- Found in src/TSwapPool.sol [Line: 459](src/TSwapPool.sol#L459)

	```solidity
	                1e18,
	```

- Found in src/TSwapPool.sol [Line: 468](src/TSwapPool.sol#L468)
